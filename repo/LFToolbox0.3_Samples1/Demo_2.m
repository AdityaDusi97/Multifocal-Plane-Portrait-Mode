...
%%
% Decoded File path
fName = fullfile('Images','IMG_7590__Decoded.mat');
...
%% let's now use depth map from lytro
depth = im2double(imread('Images/IMG_7590.png'));
I = depth;
I = downsample_self(I);
